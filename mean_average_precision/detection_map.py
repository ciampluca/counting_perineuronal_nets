...
class DetectionMAP:
    ...
    def plot(self, interpolated=True, class_names=None):
        ...
        # Added
            ...
            average_precision = self.compute_ap(precisions, recalls)
            class_name = class_names[0] if class_names else "Class {}".format(0)
            self.plot_pr(axes, class_name, precisions, recalls, average_precision)
            mean_average_precision.append(average_precision)
    ...
    # Added.
    # Since we have just one class, map is the same as ap
